  ...
  return (
    <>
      ...
      <p>
        ...
        <span className="blue">nice community</span> amongst gamers.
      </p>
      <p>
        ...
        <span className="blue">reliable</span> and{' '}
        <span className="blue">trust-worthy</span> approach rather than taking
...
function OneManTeam() {
  return (
    <InfoBox header="QUICK NOTE !!!">
      <p className="sm">
        I am a solo <WaveText text={'solo developer'} /> on this project. Part of why I am
