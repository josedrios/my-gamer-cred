...
function UniversalCard({
  ...
  return (
    <div
      className={`card universal-card ${type === 'player' ? 'universal-card__player' : ''}`}
    >
      {type === 'player' ? (
        <>
          <div
          ...
          />
          <p className="universal-card__username">SOMEDUDE</p>
          <p className="universal-card__reviews">{rand(10, 40)} reviews</p>
          <p className="universal-card__gc">
            {' '}
            <IoCubeOutline />
            {rand(100, 800)}
          </p>
